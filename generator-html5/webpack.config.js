...
module.exports = {
    ...
    resolve:{
        ...
        alias: {
            ...
            'fancybox':'fancybox/dist/js/jquery.fancybox.js',
            'big':'big.js/big.min.js',
            'bd-share':libraryPath + `baidu_share.js`,
            'jquery.extension':libraryPath + `jquery.extension.js`,
            'jquery.ajaxfileupload':__dirname + `/static/${static_main_name}/script/library/jquery.ajaxfileupload.js`,
            'jquery-ui-css': 'jquery-ui/../../themes/base/jquery-ui.css',
            'jquery-balloon': __dirname + `/static/${static_main_name}/script/library/jquery.balloon/jquery.balloon.js`,
            'jquery-core': __dirname + `/static/${static_main_name}/script/library/jquery_core.js`,
            'jquery-tooltips': __dirname + `/static/${static_main_name}/script/library/jquery_tooltips.js`,
            'tipsy':libraryPath + `tipsy.js`,
            'dropdown':libraryPath + `dropdown.js`,
            'zr_content_slider':libraryPath + `zr_content_slider.js`
        }
    },
    entry: entries(files),
    output: {
